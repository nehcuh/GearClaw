                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .rounded_lg()
                            .text_sm()
                            .when(is_user, |el| el.bg(user_bubble).text_color(gpui::white()))
                            .when(!is_user && !is_error, |el| {
                                el.bg(assistant_bubble).text_color(text_color)
                            })
                            .when(is_error, |el| el.bg(error_color).text_color(gpui::white()))
                            ...
                            .child(
                                div()
                                    ...
                                    .flex_row()
                                    .gap(px(4.))
                                    // Regenerate button - shown on hover (only for assistant messages)
                                    .when(!is_user && !is_error, |el| {
                                        el.child(
                                            div()
                                                .id(ElementId::Name(format!("regen-{}", i).into()))
                                                .px(px(6.))
                                                .py(px(2.))
                                                .rounded_md()
                                                .bg(assistant_bubble)
                                                ...
                                                .on_click(cx.listener(
                                                    move |this, _event, window, cx| {
                                                        this.regenerate_message(i, window, cx);
                                                    },
                                                )),
                                        )
                                    })
            ...
            .when(self.messages.is_empty() && !self.is_loading, |el| {
                el.child(
                    div()
                        ...
                        .flex_grow()
                        .gap(px(8.))
                        .child(div().text_xl().text_color(text_muted).child("🦞 GearClaw"))
                        .child(
                            div()
                                .text_sm()
                                .text_color(text_muted)
